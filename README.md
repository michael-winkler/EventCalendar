...
## Sample app
https://github.com/michael-winkler/EventCalendar/releases/download/1.13.0/app-release-unsigned.apk
...
dependencies {
    implementation 'com.github.michael-winkler:EventCalendar:1.13.0'
}
```
